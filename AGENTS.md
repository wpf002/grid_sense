# GridSense — Codex Handoff

Welcome. This file is written for you (Codex) so you can be productive in this repo in minutes. Read it end-to-end before making changes.
...
**For Codex, replace these with a real scheduler:**
...
The v1 surface is complete. These are the deep-codebase tasks best done in Codex:
...
## Recommended first PRs in Codex
